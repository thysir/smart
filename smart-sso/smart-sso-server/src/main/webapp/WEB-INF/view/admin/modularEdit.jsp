	...
	<div class="col-xs-12">
		...
		<form id="_editForm" class="form-horizontal" role="form" 
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix help-validate">
						<input id="_name" name="name" type="text" value="${bean.name}" class="form-data col-xs-10 col-sm-5" placeholder="模块名称"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix help-validate">
						<input id="_code" name="code" type="text" value="${bean.code}" class="form-data col-xs-10 col-sm-5" placeholder="应用编码"
		...
		jQuery(function($) {
			...
			$("#_submit").click(function(){
				if($('#_editForm').validate()){
					var btn = $(this);
					btn.button('loading');
					$.post("${_path}/admin/modular/save", $.formJson('_editForm'),function(d) {
						if(d){
							btn.button('reset');
							if(d.status == '0000'){
								window.location.href = "${_path}/admin/admin#/admin/modular?appId=${bean.appId}";
							}
							else {
								location.reload();
							}
			...
			$("#_cancle").click(function(){
				window.location.href = "${_path}/admin/admin#/admin/modular";
			});
