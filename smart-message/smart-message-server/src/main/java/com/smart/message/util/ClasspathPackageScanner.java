...
public class ClasspathPackageScanner {
    ...
    public List<String> getFullyQualifiedClassNameList(){
        return doScan(basePackage, null, new ArrayList<String>());
    }
    
    public List<String> getFullyQualifiedClassNameList(Class<?> parentClass){
    	
        return doScan(basePackage, parentClass, new ArrayList<String>());
	}
     ...
     * @throws IOException
     */
    private List<String> doScan(String basePackage, Class<?> parentClass, List<String> nameList){
            ...
            if (isClassFile(name)) {
            	 try {
            		 if(parentClass==null){
            			 ...
            			 String calssFullName=toFullyQualifiedName(name, basePackage);
            			 if (parentClass.isAssignableFrom(Class.forName(calssFullName))) {
            				 nameList.add(toFullyQualifiedName(name, basePackage));
            			 }
            		 }
				} catch (Exception e) {
                ...
                doScan(basePackage + "." + name, parentClass, nameList);
            }
        }
